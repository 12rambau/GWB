convert = {
    ...
    4: {
        ...
        "io": ["background", "foreground", "spe_background_1", "spe_background_2"],
    },
    2: {"label": ["background", "foreground"], "io": ["background", "foreground"]},
    3: {
        "label": [
    ...
    5: {  # there is no 5 class based module, it's just that the p223 module make too many different things and is not build on the same structure as the others
        "label": ["background", "foreground", "special background"],
        "io": ["background", "foreground", "spe_background"],
    },
}
